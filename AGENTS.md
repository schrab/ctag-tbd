...
## Common Workflows
- Before implementing new features or changes, first check that the project builds successfully.
- ESP-IDF is located at ~/esp-idf — use this path when building/flashing.
- Follow the phased implementation plan sequentially — don't jump ahead or skip phases.
